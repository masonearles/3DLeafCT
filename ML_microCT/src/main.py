...
while selection != "7":
    ...
    if selection=="1": #image loading and pre-processing
		...
		while selection5 != "5":
			...
			if selection5=="1":
				RFLeafSeg.RFPredictCTStack_out = RFPredictCTStack(rf_transverse,gr_s, pr_s, localthick_stack,"transverse")
			elif selection5=="2":
